...
const spreadMines  = (board, minesAmount) => {
    ...
    //Plant mines into the board array
    while(minesPlanted < minesAmount) {
        const rowSel = parseInt(Math.random() * rows, 10)
        const columnSel = parseInt(Math.random() * columns, 10)
        
        //Make shure if bomb is already planted
...
//Get Create board + Spread Mines and Create new board with both
...
//Make sure that the neighborhood is safe
